...
namespace RAHSys.Aplicacao.Interfaces
{
    public interface IRegistroRecorrenciaAppServico : IAppServicoBase<RegistroRecorrenciaAppModel>
    {
        ...
        void FinalizarRegistroRecorrencia(int idAtividade, DateTime dataRealizacaoPrevista, DateTime dataRealizacao, string observacao, List<ArquivoAppModel> evidencias);
    }
}
