...
function ExibirAtividade(atividade) {
    if (atividade != null) {
        ...
        urlFinalizarAtividade += '?id=' + atividade.IdAtividade + '&data=' + data + '&urlRetorno=' + encodeURIComponent($('#inputUrlRetorno').val());
        urlEvidencias += '?id=' + atividade.IdRecorrencia + '&urlRetorno=' + encodeURIComponent($('#inputUrlRetorno').val());
